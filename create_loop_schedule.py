...
print()
f=open(f"{code_dir}/loop_schedule.py").readlines()
...
f1=open(f"{run_script_dir}/loop_schedule-{run_script_dir}.py","w+")
for i in f:
    f1.writelines(i)
f1.close()
print(f"{run_script_dir}/loop_schedule-{run_script_dir}.py created!")
